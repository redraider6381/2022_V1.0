...
public class Mecanum {
    ...
    public static Wheels motionToWheels(Motion motion) {
        ...
        double frontLeft = vD *Math.sqrt(2)* Math.sin(thetaD + Math.PI / 4) + vTheta;
        double frontRight  = vD *Math.sqrt(2)* Math.cos(thetaD + Math.PI / 4) - vTheta;
        double backLeft = vD *Math.sqrt(2)* Math.cos(thetaD + Math.PI / 4) + vTheta;
        double backRight = vD *Math.sqrt(2)* Math.sin(thetaD + Math.PI / 4) - vTheta;
